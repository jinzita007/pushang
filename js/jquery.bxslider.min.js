...
function(t) {
    ...
    t.fn.bxSlider = function(n) {
        ...
        w = function() {
            ...
            i = x(), s = 0; i > s; s++) {
                var n = "";
                o.settings.buildPager && t.isFunction(o.settings.buildPager) ? (n = o.settings.buildPager(s), o.pagerEl.addClass("bx-custom-pager")) : (o.pagerEl.addClass("bx-default-pager")),
